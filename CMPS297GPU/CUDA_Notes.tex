...
% \begin{figure}
% \centering
% \includegraphics[width=0.8\textwidth]{images/截屏2026-04-28 下午2.20.55.png}
% \end{figure}
...
\item can only allocate up to 64 KB
...
\begin{figure}
\centering
\includegraphics[width=0.48\textwidth]{images/image-11.png}
\caption{SpMV/COO}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.48\textwidth]{images/image-10.png}
\caption{SpMV/CSR}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.48\textwidth]{images/image-12.png}
\caption{SpMV ELL}
\end{figure}
